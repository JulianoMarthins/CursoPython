"""
        Operadores lógicos são palavras chaves que auxiliam na checagem por 
    condições para valores booleanos, elas ligam dois valores a ser chegado, 
    retornando verdadeiro ou false dependendo de sua exigência
    ...
    not ->  Valor negacional, inverte o valor da expressão, ou seja, se ela retornar 
    
    verdadeiro, e usarmos o not, ela inverterá o retorno para falso
...
if 'Jul' not in nome:
    print('Perceba que este trecho de código não será executado pois, apesar de \
          ter "Jul" na palavra Juliano, a expressão esta com a negação "not", a \
          leitura seria, "se não tiver Jul em Juliano"')


# Um uso interessante para o operador or

# A variavel senha receberá a string "Não digitou nenhum valor" caso o usuário não 
# digite nada na solicitação de senha
