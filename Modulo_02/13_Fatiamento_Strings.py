"""
    ...
    Juliano Martins possui 14 letras, porem, na programação, o espaço entre os dois nomes contam, totalizando 15 caracters

    O que devemos ter atenção no incio é que em programação, a grande maioria das linguagens de programaçaõ iniciam suas
    contagens no zero, logo, Juliano tem 7 letras porem, na contagem do computador, continuam sendo 7 valores mas a ultima letra,
    a letra o, é representada pelo número 6
...
print('Acessando o indice 5 => ', nome[5]) # Retorna o caracter de número 6, isso porque a contagem se inicia no 0. Neste caso, retorna a letra n
...
# Podemos usar o -1 para acessar o ultimo caracters, idependentemente de quanto caracters a variavel tenha, ou este valor seja
# desconhecido

print('Acessando o último indice pelo valor negativo  =>',  nome[-1]) # Retorna a letra "a"

# Caso o programador precise retornar o valor contido da variavel de trás pra frente
print('Acessando a variavel de trás pra frente  =>', nome[::-1])

#Fatiamento de trás pra frente
# Código abaixo => -1 (inicia da última letra): -10(até a deciam letra de trás pra frente): -1(pula de um em um nos caracteres)
